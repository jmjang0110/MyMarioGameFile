...
class MyMountain:
    ...
    def __init__(self):
        if MyMountain.mountainImage == None:
            MyMountain.mountainImage = load_image('mario_map_tile/mapObj2.png')

        self.image_WIDTH = 235
        ...
        self.Tile_Width_size = 1200
        self.Tile_Height_size = 300
    ...
    def draw(self):
        ...
        if self.tileLength == 1:
            self.mountainImage.clip_draw(85, 949 - self.image_HEIGHT,self.image_WIDTH, self.image_HEIGHT,
                                        self.x,self.y  ,self.Tile_Width_size ,self.Tile_Height_size)
        elif self.tileLength == 2:
            self.mountainImage.clip_draw(15, 448 - self.image_HEIGHT,self.image_WIDTH, self.image_HEIGHT,
